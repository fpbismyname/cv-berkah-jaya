...
const content = () => {
  return (
    <div className="flex flex-col p-24 desktop:p-8 mobile:p-0 tablet:p-0 gap-24 mobile:gap-12 tablet:gap-12">
      {/* Welcome Contenr */}
      <div className="flex flex-col p-0 rounded-md tablet:p-28 mobile:p-10 justify-center">
        ...
        <div className="flex flex-row mobile:flex-col tablet:flex-col justify-center gap-12 ">
          <div className="flex flex-col justify-center gap-12 tablet:gap-8 mobile:gap-4 ">
            <div className="flex bg-white p-5 rounded-md flex-col justify-center gap-4 tablet:w-full mobile:w-full text-center shadow-md">
              <i className="bi bi-house-gear-fill text-7xl text-orange-500 drop-shadow-[0px_0px_5px_orange]"></i>
              ...
              <p className="text-md tablet:text-md mobile:text-sm">
                CV Berkah Jaya menyediakan layanan konstruksi yang komprehensif
                untuk memenuhi berbagai kebutuhan proyek bangunan Anda. Kami
                menawarkan solusi yang mencakup seluruh proses pembangunan, dari
                perencanaan awal hingga penyelesaian akhir, dengan fokus pada
          ...
          <div className="flex flex-col justify-center gap-12 tablet:gap-8 mobile:gap-4 ">
            <div className="flex bg-white p-5 rounded-md flex-col justify-center gap-4 tablet:w-full mobile:w-full text-center shadow-md">
              <i className="bi bi-houses-fill text-7xl text-orange-500 drop-shadow-[0px_0px_5px_orange]"></i>
              <h1 className="text-xl tablet:text-3xl tablet:text-center mobile:text-2xl mobile:text-center p-3">
                <span className="text-orange-500 font-bold">
                  Layanan Pemborongan
                </span>
              ...
              <p className="text-md tablet:text-md mobile:text-sm">
                ...
                Dengan sistem borongan, Anda mendapatkan kemudahan dan kejelasan
                dalam perencanaan biaya proyek.
              </p>
            </div>
          </div>
          <div className="flex flex-col justify-center gap-12 tablet:gap-8 mobile:gap-4">
            <div className="flex bg-white p-5 rounded-md flex-col justify-center gap-4 tablet:w-full mobile:w-full text-center shadow-md">
              <i className="bi bi-house-heart-fill text-7xl text-orange-500 drop-shadow-[0px_0px_5px_orange]"></i>
              <h1 className="text-xl tablet:text-3xl tablet:text-center mobile:text-2xl mobile:text-center p-3">
                <span className="text-orange-500 font-bold">
                  Layanan Renovasi
                </span>
      ...
      <div className="flex flex-col p-12 rounded-md tablet:p-28 mobile:p-10 justify-center gap-12">
        ...
        <div className="flex flex-row mobile:flex-col tablet:flex-col justify-center gap-12">
          <div className="flex flex-col justify-center gap-12 tablet:gap-8 mobile:gap-4">
            <div className="flex bg-white p-5 rounded-md flex-col justify-center gap-4 tablet:w-full mobile:w-full text-center shadow-md">
              <i className="bi bi-bookmark-star-fill text-7xl text-orange-500 drop-shadow-[0px_0px_5px_orange]"></i>
              <h1 className="text-xl tablet:text-3xl tablet:text-center mobile:text-2xl mobile:text-center p-3">
                <span className="text-orange-500 font-bold">Amanah</span>
              </h1>
              <p className="text-md tablet:text-md mobile:text-sm">
                Di CV Berkah Jaya, kami menempatkan nilai amanah sebagai
                prioritas utama. Kami memahami bahwa kepercayaan adalah fondasi
                dari setiap hubungan bisnis yang sukses.
              </p>
            </div>
          </div>
          <div className="flex flex-col justify-center gap-12 tablet:gap-8 mobile:gap-4 ">
            <div className="flex bg-white p-5 rounded-md flex-col justify-center gap-4 tablet:w-full mobile:w-full text-center shadow-md">
              <i className="bi bi-award-fill text-7xl text-orange-500 drop-shadow-[0px_0px_5px_orange]"></i>
              <h1 className="text-xl tablet:text-3xl tablet:text-center mobile:text-2xl mobile:text-center p-3">
                <span className="text-orange-500 font-bold">Profesional</span>
              </h1>
              <p className="text-md tablet:text-md mobile:text-sm">
                Profesionalisme adalah landasan utama dalam setiap pekerjaan
                yang kami lakukan. Dengan tim yang berpengalaman dan berkompeten
              </p>
            </div>
          </div>
          <div className="flex flex-col justify-center gap-12 tablet:gap-8 mobile:gap-4">
            <div className="flex bg-white p-5 rounded-md flex-col justify-center gap-4 tablet:w-full mobile:w-full text-center shadow-md">
              <i className="bi bi-shield-fill-check text-7xl text-orange-500 drop-shadow-[0px_0px_5px_orange]"></i>
              <h1 className="text-xl tablet:text-3xl tablet:text-center mobile:text-2xl mobile:text-center p-3">
                <span className="text-orange-500 font-bold">Amanah</span>
              </h1>
              <p className="text-md tablet:text-md mobile:text-sm">
