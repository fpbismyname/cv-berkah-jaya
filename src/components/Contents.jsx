      ...
      <div className="flex flex-row-reverse justify-center gap-12 tablet:flex-col-reverse mobile:flex-col-reverse tablet:gap-8 mobile:gap-4">
        <div className="flex flex-col justify-center w-1/2 gap-4 tablet:w-full mobile:w-full">
          ...
          <p className="text-md tablet:text-md mobile:text-sm">
            ...
            menjadi mitra Anda dalam mewujudkan berbagai proyek konstruksi yang
            berkualitas tinggi.
          </p>
        </div>
        <div className="flex flex-col">
        ...
        <div className="flex flex-col justify-center gap-12 tablet:gap-8 mobile:gap-4 ">
          <div className="flex bg-white p-5 rounded-md flex-col justify-center gap-4 tablet:w-full mobile:w-full text-center shadow-md">
            ...
            <p className="text-md tablet:text-md mobile:text-sm">
              ...
              untuk berbagai jenis proyek, baik skala kecil maupun besar. Dengan
              sistem borongan, Anda mendapatkan kemudahan dan kejelasan dalam
        ...
        <div className="flex flex-col justify-center gap-12 tablet:gap-8 mobile:gap-4">
          <div className="flex bg-white p-5 rounded-md flex-col justify-center gap-4 tablet:w-full mobile:w-full text-center shadow-md">
            ...
            <p className="text-md tablet:text-md mobile:text-sm">
              ...
              memperbaiki dan memperbarui bangunan Anda, memberikan tampilan dan
              fungsi yang lebih baik. Baik untuk renovasi rumah tinggal, kantor,
              maupun bangunan komersial, kami siap membantu Anda.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-row mobile:flex-col tablet:flex-col justify-center gap-12">
        <div className="flex flex-col justify-center gap-12 tablet:gap-8 mobile:gap-4">
          <div className="flex bg-white p-5 rounded-md flex-col justify-center gap-4 tablet:w-full mobile:w-full text-center shadow-md">
            ...
            <p className="text-md tablet:text-md mobile:text-sm">
              Di CV Berkah Jaya, kami menempatkan nilai amanah sebagai prioritas
              utama. Kami memahami bahwa kepercayaan adalah fondasi dari setiap
        ...
        <div className="flex flex-col justify-center gap-12 tablet:gap-8 mobile:gap-4 ">
          <div className="flex bg-white p-5 rounded-md flex-col justify-center gap-4 tablet:w-full mobile:w-full text-center shadow-md">
            ...
            <p className="text-md tablet:text-md mobile:text-sm">
              Profesionalisme adalah landasan utama dalam setiap pekerjaan yang
              kami lakukan. Dengan tim yang berpengalaman dan berkompeten
            </p>
          </div>
        </div>
        <div className="flex flex-col justify-center gap-12 tablet:gap-8 mobile:gap-4">
          <div className="flex bg-white p-5 rounded-md flex-col justify-center gap-4 tablet:w-full mobile:w-full text-center shadow-md">
            ...
            <p className="text-md tablet:text-md mobile:text-sm">
              ...
              proyek. Kami memberikan jaminan atas setiap pekerjaan yang kami
              lakukan, memberikan rasa aman dan kepuasan kepada klien.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="fixed z-10 bottom-10 right-10 bg-white p-5 rounded-full cursor-pointer hover:drop-shadow-[0px_0px_10px_#37eb34] drop-shadow-md transition mobile:p-3 tablet:p-3">
      <div className="flex flex-row gap-5 h-full w-full mobile:gap-3 tablet:gap-3">
        <a
          href="https://wa.me/+6281572497182"
          className="flex flex-row gap-4 justify-center items-center "
        >
          <img
            src={Icon_Whatsapp}
            className="w-[30px] mobile:w-[20px] tablet:w-[20px]"
          />
