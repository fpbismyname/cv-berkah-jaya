...
const whatsapp = () => {
  return (
    <div className="fixed z-10 bottom-10 right-10 bg-white p-5 rounded-full cursor-pointer hover:drop-shadow-[0px_0px_10px_#37eb34] transition mobile:p-3 tablet:p-3">
